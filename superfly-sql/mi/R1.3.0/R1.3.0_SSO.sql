...
call run_install_command('alter table subsystems add constraint fk_subsystems_smtp_servers foreign key (ssrv_ssrv_id) references smtp_servers (ssrv_id)', '42S21');
