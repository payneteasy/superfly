...
create procedure ui_update_user(i_user_id int(10),
 ...
 main_sql:
  begin
    update users
       set user_password     = coalesce(i_user_password, user_password), email  = i_user_email, name = i_name, surname = i_surname, secret_question = i_secret_question, secret_answer = i_secret_answer
