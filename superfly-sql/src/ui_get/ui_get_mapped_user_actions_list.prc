drop procedure if exists ui_get_mapped_user_actions_list;
delimiter $$
create procedure ui_get_mapped_user_actions_list(i_start_from int(10),
...
$$
delimiter ;
call save_routine_information('ui_get_mapped_user_actions_list',
                              concat_ws(',',
                                        'user_id int',
                                        'user_name varchar',
