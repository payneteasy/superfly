drop procedure if exists ui_get_all_role_actions_list;
delimiter $$
create procedure ui_get_all_role_actions_list(i_start_from int(10),
...
$$
delimiter ;
call save_routine_information('ui_get_all_role_actions_list',
                              concat_ws(',',
                                        'role_id int',
                                        'role_name varchar',
