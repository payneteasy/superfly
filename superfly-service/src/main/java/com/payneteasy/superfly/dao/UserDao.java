...
public interface UserDao {
	 ...
	 *            password to use
	 * @param subsystemName
	 *            name of the subsystem used to authenticate
	 * @param ipAddress
	 ...
	 * 
	 * @param subsystemName
	 *            name of the subsystem from which to obtain info
	 ...
	 *            number of the field to order by
	 * @param orderType
	 *            asc/desc
	 * @param userNamePrefix
	 *            prefix of the username (ignored if null)
	 * @param roleId
	 *            ID of the role which users must have (ignored if null)
	 * @param complectId
	 *            ID of the complect which users must have (ignored if null)
	 * @param subsystemId
	 *            ID of the subsystem to which user has access (ignored if null)
	 * @return users
	 */
	 ...
	 * @param subsystemIds
	 *            comma-separated list of IDs of subsystems which roles are to
	 ...
	 * @param rolesToAddIds
	 *            comma-separated list of IDs of roles to be added
	 * @param rolesToRemoveIds
	 *            comma-separated list of IDs of roles to be removed
	 * @param rolesToGrantActionsIds
	 *            comma-separated list of IDs of roles from which all roles will
	 ...
	 * @param userId
	 *            ID of the user to change
	 * @param roleActionToAddIds
	 *            comma-separated list of IDs of action+roles to be added
	 * @param roleActionToRemoveIds
	 *            comma-separated list of IDs of action+roles to be removed
	 * @return routine result
	 */
	 ...
	 * @param subsystemIds
	 *            IDs of subsystems to which roles and actions must be
	 *            restricted (ignored if null)
	 * @param actionNameSubstring
	 *            substring which must be contained in the action name to allow
	 *            action in the list
	 * @param roleNameSubstring
	 *            substring which must be contained in the role name to allow
	 *            role in the list
	 ...
	 *            comma-separated list of principal names
	 * @return routine result
	 */
