...
public class InternalSSOServiceLoggingTest extends AbstractServiceLoggingTest {
    ...
    public void testRegisterUser() throws Exception {
        ...
        internalSSOService.registerUser("new-user", "new-password", "new-email", null, new RoleGrantSpecification[] {}, "user", "user", "question", "answer", null,"test organization", HOTPType.NONE);
    ...
    public void testRegisterUserDuplicate() throws Exception {
        ...
        try {
            internalSSOService.registerUser("new-user", "new-password", "new-email", null,
                    new RoleGrantSpecification[] {}, "user", "user", "question", "answer", null,"test organization", HOTPType.NONE);
