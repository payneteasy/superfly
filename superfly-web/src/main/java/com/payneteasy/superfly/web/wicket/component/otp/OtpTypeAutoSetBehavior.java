 ...
 * <p>
 * The rule is applied in the admin UI only: the service layer stores whatever it is given,
 * so a client calling the remote API directly can still set mandatory OTP without a type.
 */
